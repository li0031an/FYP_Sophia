...
public class AsyncTaskCreateProjectFolder extends AsyncTask<Object, Object, Object> implements Settings{
    ...
    String newFolerId;
    CreateProjectFolderListener createProjectFolderListener;

    public AsyncTaskCreateProjectFolder(CreateProjectFolderListener createProjectFolderListener, String newFolderName, Context context, String parentFolderId, SharedPreferences settings, String projectId){
        this.createProjectFolderListener = createProjectFolderListener;
    ...
    protected void onPostExecute(Object result) {
        ...
        if (null != result) {
            ...
            if (null != newFolerId) {
                createProjectFolderListener.onCreateProjectFolderReady(newFolerId);
            } else {
                //do nothing
            }
        }
